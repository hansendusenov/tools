...
Run directly from GitHub (no installation required)
    ...
    curl -sL https://raw.githubusercontent.com/hansendusenov/tools/main/sysinfo.sh | bash

or

    wget -qO- https://raw.githubusercontent.com/hansendusenov/tools/main/sysinfo.sh | bash
